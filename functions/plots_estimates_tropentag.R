...
# this is placeholder, lit and estimate, during fieldwork
# as presented at Tropentag 2025
...
# SAVE THE PLOTS
ggsave("figures/tropentag/plot1_adoption_rates_est.png", plot1, width = 8, height = 6, dpi = 300)
ggsave("figures/tropentag/plot2_adoption_intensity_est.png", plot2, width = 8, height = 6, dpi = 300)
ggsave("figures/tropentag/plot3_yield_relationship_est.png", plot3, width = 8, height = 6, dpi = 300)
ggsave("figures/tropentag/plot4_modelled_effect_est.png", plot4, width = 8, height = 6, dpi = 300)
